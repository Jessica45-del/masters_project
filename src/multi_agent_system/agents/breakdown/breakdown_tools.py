...
async def extract_hpo_ids(phenopacket: dict) -> list[str]:
...
async def render_prompt(hpo_ids: list[str], sex: str, pkt_id: str) -> str: #pkt_id = phenopacket(patient id)
